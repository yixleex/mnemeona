...
/*
 * --------------------------------------------------
 * Find the chapter containing the active scene
 * --------------------------------------------------
 */

function findChapterForScene(
  acts: typeof import("@/types/manuscript").Act[],
  sceneId: string | null,
): string | null {
  if (!sceneId) {
    return null
